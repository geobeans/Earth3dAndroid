...
LOCAL_SRC_FILES :=	GeoNativeLib.cpp GeoMainApp.cpp GeoAndroidNotifyHandler.cpp \
					GLES2ShaderGenVisitor.cpp EarthMultiTouchManipulator.cpp \
					GeoScene.cpp SceneGraphChangeCallback.cpp \
					PickHandler.cpp GeoScene2.cpp Compute.cpp ArrowHead.cpp ArrowPoint.cpp \
					ArrowStyle.cpp Bezier.cpp BezierPoint.cpp GeomUtil.cpp GMatrix.cpp \
					GV00010.cpp GV00008.cpp GVCoord.cpp SpecialGeomUtil.cpp Compass.cpp \
					QuadPlugin.cpp QuadTileSource.cpp PlaceNodeEditor.cpp
